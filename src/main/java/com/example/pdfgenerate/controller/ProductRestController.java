...
import com.example.pdfgenerate.service.ProductService;
...
public class ProductRestController {
	...
	@GetMapping("/report/productpdf/")
	public ResponseEntity<Resource> generateExcelReport() throws IOException, DocumentException {
		List<Product> productsLst = productService.generateExcelReport();
		...
		for (Product product : productsLst) {
